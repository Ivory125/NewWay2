...
bool CActorInstance::IsGrowthPet()
{
	int PetTable[] =
	{
		...
		34049, 34050, // Razador
		34053, 34054, // Nemere
		34036, 34037, // Blue Dragon
		34064, 34065, // Mini Meley
		34073, 34074, // Normal Azrael
		34075, 34076, // Moppelchen
		34080, 34081, // Baashido
		34082, 34083, // Nessi
		34047, 34048, // Exedyars Brut
		34077, 34078, // Zorniger Mini-Alastor
		34165, 34166, // Baby Kommandant
	};

	for (int j = 0; j < sizeof(PetTable) / sizeof(PetTable[0]); j++) {
		if (m_eRace >= PetTable[j])
			return true;
	}
