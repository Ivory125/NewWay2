...
/////////////////////////////////////////////////////////////ORIGINAL/////////////////////////////////
	...
	public:
		...
		void					BlockMovement();
#ifdef ELEMENT_SPELL_WORLDARD
		void					SetElementEffect(BYTE wElementsEffect);
		BYTE					GetElementEffect();
		void					ClearElementEffect();
		void					AttachElementEffect(CItemData* pItem);
#endif
...
#ifdef ELEMENT_SPELL_WORLDARD
		BYTE 					m_dwElementsEffect;
		DWORD					m_swordElementEffectRight;
		DWORD					m_swordElementEffectLeft;
#endif
#ifdef ENABLE_ACCE_COSTUME_SYSTEM
