...
void initapp()
{
	...
	PyModule_AddIntConstant(poModule, "ELEMENT_SPELL_WORLDARD", 1);
#else
	PyModule_AddIntConstant(poModule, "ELEMENT_SPELL_WORLDARD", 0);
#endif
...
#ifdef ENABLE_FAST_ADD_STATUS
	PyModule_AddIntConstant(poModule, "ENABLE_FAST_ADD_STATUS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_FAST_ADD_STATUS", 0);
#endif

#ifdef ENABLE_REFINE_CHECKBOX
	PyModule_AddIntConstant(poModule, "ENABLE_REFINE_CHECKBOX", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_REFINE_CHECKBOX", 0);
#endif

#ifdef ENABLE_SHOW_MONEY_ON_OFF
	PyModule_AddIntConstant(poModule, "ENABLE_SHOW_MONEY_ON_OFF", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SHOW_MONEY_ON_OFF", 0);
#endif
...
#ifdef ENABLE_ASLAN_TELEPORTPANEL
	PyModule_AddIntConstant(poModule, "ENABLE_ASLAN_TELEPORTPANEL", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ASLAN_TELEPORTPANEL", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_ASLAN_GROWTH_PET_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ASLAN_GROWTH_PET_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_EXTENDED_PICKUP", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_EXTENDED_PICKUP", 0);
#endif
