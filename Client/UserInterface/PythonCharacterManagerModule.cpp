...
void initchrmgr()
{
	...
	PyModule_AddIntConstant(poModule, "EFFECT_NEW_STONE_SYSTEM", CInstanceBase::EFFECT_NEW_STONE_SYSTEM);
#endif
	...
	PyModule_AddIntConstant(poModule, "EFFECT_PET_SKILL_RESTAURATION", CInstanceBase::EFFECT_PET_SKILL_RESTAURATION);
	PyModule_AddIntConstant(poModule, "EFFECT_PET_SKILL_IMMORTAL", CInstanceBase::EFFECT_PET_SKILL_IMMORTAL);
	PyModule_AddIntConstant(poModule, "EFFECT_PET_SKILL_PANACEA", CInstanceBase::EFFECT_PET_SKILL_PANACEA);
	PyModule_AddIntConstant(poModule, "EFFECT_PET_SKILL_FEATHERLIGHT", CInstanceBase::EFFECT_PET_SKILL_FEATHERLIGHT);
#endif
}
