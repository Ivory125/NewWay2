...
protected:
	...
	public:
		...
		void 	SetElement(TItemPos Cell, BYTE value_grade_element, BYTE type_element);
		void 	SetElementAttack(TItemPos Cell, DWORD attack_element_index, DWORD attack_element);
		void 	SetElementValue(TItemPos Cell, DWORD elements_value_bonus_index, short elements_value_bonus);
		BYTE 	GetElementGrade(TItemPos Cell);
		DWORD 	GetElementAttack(TItemPos Cell, DWORD attack_element_index);
		BYTE 	GetElementType(TItemPos Cell);
		short 	GetElementValue(TItemPos Cell, DWORD elements_value_bonus_index);
#endif
