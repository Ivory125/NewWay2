...
def __InitData():
	...
	if app.__AUTO_QUQUE_ATTACK__:
		chrmgr.RegisterCacheEffect(chrmgr.EFFECT_NEW_STONE_SYSTEM, "", "d:/ymir work/effect/etc/autohunt/autohunt.mse")
	...
	if app.ENABLE_ASLAN_GROWTH_PET_SYSTEM:
		chrmgr.RegisterCacheEffect(chrmgr.EFFECT_PET_SKILL_RESTAURATION, "", "d:/ymir work/effect/pet/pet_skill_restoration.mse")
		chrmgr.RegisterCacheEffect(chrmgr.EFFECT_PET_SKILL_IMMORTAL, "", "d:/ymir work/effect/pet/pet_skill_immortal.mse")
		chrmgr.RegisterCacheEffect(chrmgr.EFFECT_PET_SKILL_PANACEA, "", "d:/ymir work/effect/pet/pet_skill_panacea.mse")
		chrmgr.RegisterCacheEffect(chrmgr.EFFECT_PET_SKILL_FEATHERLIGHT, "", "d:/ymir work/effect/pet/pet_skill_featherlight.mse")
...
def __LoadGameEffect():
	...
	if app.ELEMENT_SPELL_WORLDARD:
		INDEX_APPLY_ELEMENT = 105
		#INDEX_APPLY_ELEMENT = 97

		chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-6), "PART_WEAPON", "d:/ymir work/pc/common/effect/sword/element01_electric.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-5), "PART_WEAPON", "d:/ymir work/pc/common/effect/sword/element02_fire.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-4), "PART_WEAPON", "d:/ymir work/pc/common/effect/sword/element03_ice.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-3), "PART_WEAPON", "d:/ymir work/pc/common/effect/sword/element04_wind.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-2), "PART_WEAPON", "d:/ymir work/pc/common/effect/sword/element05_daeji.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-1), "PART_WEAPON", "d:/ymir work/pc/common/effect/sword/element06_dark.mse")

		chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-6)+INDEX_APPLY_ELEMENT, "PART_WEAPON", "d:/ymir work/pc/common/effect/sword/element01_electric_f.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-5)+INDEX_APPLY_ELEMENT, "PART_WEAPON", "d:/ymir work/pc/common/effect/sword/element02_fire_f.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-4)+INDEX_APPLY_ELEMENT, "PART_WEAPON", "d:/ymir work/pc/common/effect/sword/element03_ice_f.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-3)+INDEX_APPLY_ELEMENT, "PART_WEAPON", "d:/ymir work/pc/common/effect/sword/element04_wind_f.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-2)+INDEX_APPLY_ELEMENT, "PART_WEAPON", "d:/ymir work/pc/common/effect/sword/element05_daeji_f.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-1)+INDEX_APPLY_ELEMENT, "PART_WEAPON", "d:/ymir work/pc/common/effect/sword/element06_dark_f.mse")

		chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-6)+(INDEX_APPLY_ELEMENT*2), "PART_WEAPON_LEFT", "d:/ymir work/pc/common/effect/sword/element01_electric_b.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-5)+(INDEX_APPLY_ELEMENT*2), "PART_WEAPON_LEFT", "d:/ymir work/pc/common/effect/sword/element02_fire_b.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-4)+(INDEX_APPLY_ELEMENT*2), "PART_WEAPON_LEFT", "d:/ymir work/pc/common/effect/sword/element03_ice_b.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-3)+(INDEX_APPLY_ELEMENT*2), "PART_WEAPON_LEFT", "d:/ymir work/pc/common/effect/sword/element04_wind_b.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-2)+(INDEX_APPLY_ELEMENT*2), "PART_WEAPON_LEFT", "d:/ymir work/pc/common/effect/sword/element05_daeji_b.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-1)+(INDEX_APPLY_ELEMENT*2), "PART_WEAPON_LEFT", "d:/ymir work/pc/common/effect/sword/element06_dark_b.mse")

		chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-6)+(INDEX_APPLY_ELEMENT*3), "PART_WEAPON", "d:/ymir work/pc/common/effect/sword/element01_electric_s.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-5)+(INDEX_APPLY_ELEMENT*3), "PART_WEAPON", "d:/ymir work/pc/common/effect/sword/element02_fire_s.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-4)+(INDEX_APPLY_ELEMENT*3), "PART_WEAPON", "d:/ymir work/pc/common/effect/sword/element03_ice_s.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-3)+(INDEX_APPLY_ELEMENT*3), "PART_WEAPON", "d:/ymir work/pc/common/effect/sword/element04_wind_s.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-2)+(INDEX_APPLY_ELEMENT*3), "PART_WEAPON", "d:/ymir work/pc/common/effect/sword/element05_daeji_s.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-1)+(INDEX_APPLY_ELEMENT*3), "PART_WEAPON", "d:/ymir work/pc/common/effect/sword/element06_dark_s.mse")

		chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-6)+(INDEX_APPLY_ELEMENT*4), "PART_WEAPON_LEFT", "d:/ymir work/pc/common/effect/sword/element01_electric_s.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-5)+(INDEX_APPLY_ELEMENT*4), "PART_WEAPON_LEFT", "d:/ymir work/pc/common/effect/sword/element02_fire_s.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-4)+(INDEX_APPLY_ELEMENT*4), "PART_WEAPON_LEFT", "d:/ymir work/pc/common/effect/sword/element03_ice_s.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-3)+(INDEX_APPLY_ELEMENT*4), "PART_WEAPON_LEFT", "d:/ymir work/pc/common/effect/sword/element04_wind_s.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-2)+(INDEX_APPLY_ELEMENT*4), "PART_WEAPON_LEFT", "d:/ymir work/pc/common/effect/sword/element05_daeji_s.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-1)+(INDEX_APPLY_ELEMENT*4), "PART_WEAPON_LEFT", "d:/ymir work/pc/common/effect/sword/element06_dark_s.mse")

		if app.ENABLE_WOLFMAN_CHARACTER:
			chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-6)+(INDEX_APPLY_ELEMENT*5), "PART_WEAPON", "d:/ymir work/pc/common/effect/sword/element01_electric_w.mse")
			chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-5)+(INDEX_APPLY_ELEMENT*5), "PART_WEAPON", "d:/ymir work/pc/common/effect/sword/element02_fire_w.mse")
			chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-4)+(INDEX_APPLY_ELEMENT*5), "PART_WEAPON", "d:/ymir work/pc/common/effect/sword/element03_ice_w.mse")
			chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-3)+(INDEX_APPLY_ELEMENT*5), "PART_WEAPON", "d:/ymir work/pc/common/effect/sword/element04_wind_w.mse")
			chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-2)+(INDEX_APPLY_ELEMENT*5), "PART_WEAPON", "d:/ymir work/pc/common/effect/sword/element05_daeji_w.mse")
			chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-1)+(INDEX_APPLY_ELEMENT*5), "PART_WEAPON", "d:/ymir work/pc/common/effect/sword/element06_dark_w.mse")

			chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-6)+(INDEX_APPLY_ELEMENT*6), "PART_WEAPON_LEFT", "d:/ymir work/pc/common/effect/sword/element01_electric_w.mse")
			chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-5)+(INDEX_APPLY_ELEMENT*6), "PART_WEAPON_LEFT", "d:/ymir work/pc/common/effect/sword/element02_fire_w.mse")
			chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-4)+(INDEX_APPLY_ELEMENT*6), "PART_WEAPON_LEFT", "d:/ymir work/pc/common/effect/sword/element03_ice_w.mse")
			chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-3)+(INDEX_APPLY_ELEMENT*6), "PART_WEAPON_LEFT", "d:/ymir work/pc/common/effect/sword/element04_wind_w.mse")
			chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-2)+(INDEX_APPLY_ELEMENT*6), "PART_WEAPON_LEFT", "d:/ymir work/pc/common/effect/sword/element05_daeji_w.mse")
			chrmgr.RegisterEffect(chrmgr.EFFECT_ELEMENTS_WEAPON+(INDEX_APPLY_ELEMENT-1)+(INDEX_APPLY_ELEMENT*6), "PART_WEAPON_LEFT", "d:/ymir work/pc/common/effect/sword/element06_dark_w.mse")
