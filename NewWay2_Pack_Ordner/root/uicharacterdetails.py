...
class CharacterDetailsUI(ui.ScriptWindow):
	...
	def __Initialize(self):
		...
		#self.InfoList.append( [ localeInfo.DETAILS_77, localeInfo.DETAILS_TOOLTIP_77, item.GetApplyPoint( item.APPLY_RESIST_MAGIC_REDUCTION ) ] )---WAR DEAKTIVIERT
		self.InfoList.append( [ localeInfo.DETAILS_30, localeInfo.REFINE_ELEMENT_TEXT_ELECT, item.GetApplyPoint( item.APPLY_ENCHANT_ELECT ) ] )
		self.InfoList.append( [ "", "", self.CATEGORY_ENDLINE ] )
