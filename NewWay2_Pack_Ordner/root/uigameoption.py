...
class OptionDialog(ui.ScriptWindow):
	...
	def __init__(self):
		...
		if app.ENABLE_SHOW_MONEY_ON_OFF:
	...
	def __OnClickEnableAutoPickUp(self):
		...
		chat.AppendChat(chat.CHAT_TYPE_INFO, "Das Sammeln von Gegenständen ist automatisch aktiviert!.")
	...
	def __OnClickDisableAutoPickUp(self):
		...
		chat.AppendChat(chat.CHAT_TYPE_INFO, "Automatisches Sammeln von Gegenständen deaktiviert!.")
	...
	def RefrehMoneySalesText(self):
		if systemSetting.GetMoneyOnOff():
			chat.AppendChat(chat.CHAT_TYPE_INFO, "Die Yang-Anzeige ist eingeschaltet!")
			self.showyangTextButtonList[0].Down()
			self.showyangTextButtonList[1].SetUp()
		else:
			chat.AppendChat(chat.CHAT_TYPE_INFO, "Die Yang-Anzeige ist ausgeschaltet!")
