...
class InventoryWindow(ui.ScriptWindow):
	...
	def __DropSrcItemToDestItemInInventory(self, srcItemVID, srcItemSlotPos, dstItemSlotPos):
		...
		if app.ENABLE_SOULBIND_SYSTEM and item.IsSealScroll(srcItemVID):
			...
			self.questionDialog.SetText("Möchtest du dieses Pet der Transportbox hinzufügen?")
			...
			self.questionDialog = uiCommon.QuestionDialog()
			self.questionDialog.SetText("Möchtest du dieses Pet in eine neue Transportbox hinzufügen?")
			self.questionDialog.SetAcceptEvent(ui.__mem_func__(self.UseProteinOrTransportBox))
			self.questionDialog.SetCancelEvent(ui.__mem_func__(self.OnCloseQuestionDialog))
			self.questionDialog.Open()
			self.questionDialog.src = srcItemSlotPos
			...
			self.questionDialog = uiCommon.QuestionDialog()
			self.questionDialog.SetText("Möchtest du dein Pet damit Füttern?")
			self.questionDialog.SetAcceptEvent(ui.__mem_func__(self.UseProteinOrTransportBox))
			self.questionDialog.SetCancelEvent(ui.__mem_func__(self.OnCloseQuestionDialog))
			self.questionDialog.Open()
			self.questionDialog.src = srcItemSlotPos
