			...
			if (!bEscape)
			{
				...
				while (it != pSet->end())
				{
...

					{
						...
						// iValueLen += snprintf(szValues + iValueLen, sizeof(szValues) - iValueLen, ", %u, %u, %u, %u, %u, %u", pItemAward->dwSocket0, pItemAward->dwSocket1, pItemAward->dwSocket2, pItemAward->dwSocket3, pItemAward->dwSocket4, pItemAward->dwSocket5);
						// #else
						iLen += snprintf(szColumns + iLen, sizeof(szColumns) - iLen, ", socket0, socket1, socket2");
						iValueLen += snprintf(szValues + iValueLen, sizeof(szValues) - iValueLen, ", %u, %u, %u", pItemAward->dwSocket0, pItemAward->dwSocket1, pItemAward->dwSocket2);
						// #endif
						...
						snprintf(szQuery, sizeof(szQuery),
						// #ifdef ENABLE_EXTENDED_SOCKETS
								// "INSERT INTO item%s (id, owner_id, `window`, pos, vnum, grade_elements, attackelement1, attackelement2, attackelement3, elementstype, elementsvalue1, elementsvalue2, elementsvalue3, count, socket0, socket1, socket2, socket3, socket4, socket5)"
								// "VALUES(%u, %u, '%s', %d, %u, %d, %d, %d, %d, %d, %d, %d, %d, %u, %u, %u, %u, %u, %u, %u)", 
						// #else
								"INSERT INTO item%s (id, owner_id, `window`, pos, vnum, grade_elements, attackelement1, attackelement2, attackelement3, elementstype, elementsvalue1, elementsvalue2, elementsvalue3, count, socket0, socket1, socket2) "
								"VALUES(%u, %u, '%s', %d, %u, %d, %d, %d, %d, %d, %d, %d, %d, %u, %u, %u, %u)",
						// #endif
								//"VALUES(%u, %u, '%d', %d, %u, %u, %d, %d, %d, %d, %d, %d, %d, %u, %u, %u, %u)",
								GetTablePostfix(),
								GainItemID(),
								pi->account_id,
								...
								pItemAward->dwVnum, pItemAward->dwCount, 
							// #ifdef ENABLE_EXTENDED_SOCKETS
								// pItemAward->dwSocket0, pItemAward->dwSocket1, pItemAward->dwSocket2, pItemAward->dwSocket3, pItemAward->dwSocket4, pItemAward->dwSocket5);
							// #else
								pItemAward->dwSocket0, pItemAward->dwSocket1, pItemAward->dwSocket2);
							// #endif
						#endif
					}
