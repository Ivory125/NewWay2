...
ACMD(do_pet_set_level);
ACMD(do_pet_set_evolution);
ACMD(do_pet_set_exp);
#endif
...
#endif
#ifdef ENABLE_ASLAN_GROWTH_PET_SYSTEM
	{ "petfeedadditem",			do_pet_feed_add_list,		0,				POS_DEAD,		GM_PLAYER },
	{ "petfeedeat",				do_pet_feed_eat,			0,				POS_DEAD,		GM_PLAYER },
	{ "petgettype",				do_pet_get_type,			0,				POS_DEAD,		GM_PLAYER },
	{ "petchangeattr",			do_pet_change_attr,			0,				POS_DEAD,		GM_PLAYER },
	{ "petremoveskill",			do_pet_remove_skill,		0,				POS_DEAD,		GM_PLAYER },
	{ "petevolutionopen",		do_pet_evo_open,			0,				POS_DEAD,		GM_PLAYER },
	{ "petevolutionupgrade",	do_pet_evo_upgrade,			0,				POS_DEAD,		GM_PLAYER },
	{ "pet_revive_special",		do_pet_revive_special,		0,				POS_DEAD,		GM_PLAYER },
	{ "pet_set_level",			do_pet_set_level,			0,				POS_DEAD,		GM_IMPLEMENTOR },
	{ "pet_set_evolution",		do_pet_set_evolution,			0,				POS_DEAD,		GM_IMPLEMENTOR },
	{ "pet_set_exp",			do_pet_set_exp,			0,				POS_DEAD,		GM_IMPLEMENTOR },
#endif
#ifdef ENABLE_ASLAN_BUFF_NPC_SYSTEM
	{ "buff_level",				do_buff_set_level,		0,				POS_DEAD,		GM_IMPLEMENTOR },
	{ "buff_exp",				do_buff_set_exp,			0,				POS_DEAD,		GM_IMPLEMENTOR },
	{ "buff_skill",				do_buff_set_skill,			0,				POS_DEAD,		GM_IMPLEMENTOR },
#endif
