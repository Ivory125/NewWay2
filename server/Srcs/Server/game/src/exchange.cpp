...
// Setze die Attribute des Austauschpakets auf die entsprechenden Elementenwerte des übergebenen Items
		pack_exchg.grade_element = ((LPITEM) pvData)->GetElementGrade();// Grad des Elements
		pack_exchg.element_type_bonus = ((LPITEM) pvData)->GetElementsType();// Typ des Elements
		thecore_memcpy(&pack_exchg.attack_element, ((LPITEM) pvData)->GetElementAttacks(), sizeof(pack_exchg.attack_element));// Angriffselemente
		thecore_memcpy(&pack_exchg.elements_value_bonus, ((LPITEM) pvData)->GetElementsValues(), sizeof(pack_exchg.elements_value_bonus));// Elementenwerte
#endif
	...
	{
// Setze die Elementenattribute des Austauschpakets auf Null
#ifdef ELEMENT_SPELL_WORLDARD
		pack_exchg.grade_element = 0;// Grad des Elements
		pack_exchg.element_type_bonus = 0;// Typ des Elements
		memset(&pack_exchg.attack_element, 0, sizeof(pack_exchg.attack_element));// Angriffselemente
		memset(&pack_exchg.elements_value_bonus, 0, sizeof(pack_exchg.elements_value_bonus));// Elementenwerte
#endif
#ifdef WJ_ENABLE_TRADABLE_ICON
