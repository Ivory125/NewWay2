...
CPacketInfoCG::CPacketInfoCG()
{
	...
	Set(HEADER_CG_REFINE, sizeof(TPacketCGRefine), "Refine", true);//nach dem bin ich gegangen in client
	...
	Set(HEADER_CG_STATE_CHECKER, sizeof(BYTE), "ServerStateCheck", false);//Laut TUT eigentlich hier darunter
...
// Konfiguration des Paket-Headers für Client-an-Server-Truhen-Drop-Informationen
	...
	Set(HEADER_CG_PET_BORN, sizeof(TPacketCGBornPet), "ReciveRequestBornPet", true);
	Set(HEADER_CG_PET_RENEW_NAME, sizeof(TPacketCGRenewPetName), "ReciveRenewPetName", true);
#endif
}
